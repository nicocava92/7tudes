...
Partial Class Lang_SRCategories
    ...
    Sub Data_Save()
        ...
        For Each gr In Me.tabA.Rows
            If gr.RowType = DataControlRowType.DataRow Then
                ...
                sSql = "Update SRCategories Set "

                T1 = gr.FindControl("SRCatName")
                sSql &= " SRCatName=N'" & Replace(T1.Text, "'", "''") & "'"

                T1 = gr.FindControl("SRCatDesc")
                sSql &= ", SRCatDesc=N'" & Replace(T1.Text, "'", "''") & "'"
