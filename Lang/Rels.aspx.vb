    ...
    Sub Data_Save()
        ...
        For Each gr In Me.tabA.Rows
            If gr.RowType = DataControlRowType.DataRow Then
                ...
                sSql = "Update Rels Set "

                T1 = gr.FindControl("RelName")
                sSql &= " RelName=N'" & Replace(T1.Text, "'", "''") & "'"

                T1 = gr.FindControl("RelDesc")
                sSql &= ", RelDesc=N'" & Replace(T1.Text, "'", "''") & "'"
