<%@ Page Title="Free Seven Tudes" Trace="false" Debug="false" Language="VB" MasterPageFile="free.master" StylesheetTheme="Freev2" AutoEventWireup="false" CodeFile="Questions10.aspx.vb" Inherits="Free_Questions10" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width:100%;padding:10px;padding-right:25px;padding-bottom:0px;"><span class="xofy">Question 10 of 12</span></div>

    <asp:SqlDataSource runat="server" ID="rsQ" ConnectionString="<%$ ConnectionStrings:c7tudes %>"
        SelectCommand="SELECT [QNo], [Question_Self] as Question, [ShowQNo_Self] as ShowQno, RespText1, RespText2, RespText3, RespText4, RespText5, RespText6, RespText7  FROM [Questions] inner join Scale on Questions.LanguageID=Scale.LanguageID WHERE (Questions.[LanguageID] = @LanguageID) and QNo = 83">
        <SelectParameters>
