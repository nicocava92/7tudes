<%@ Page Title="Seven Tudes" Trace="false" Debug="false" Language="VB" MasterPageFile="free.master" StylesheetTheme="Freev2" AutoEventWireup="false" CodeFile="Questions4.aspx.vb" Inherits="Free_Questions4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width:100%;padding:10px;padding-right:25px;padding-bottom:0px;"><span class="xofy">Page 4 of 7</span></div> 

    <asp:SqlDataSource runat="server" ID="rsQ" ConnectionString="<%$ ConnectionStrings:c7tudes %>"
        SelectCommand="SELECT [QNo], [Question_Self] as Question, Stem, [ShowQNo_Self] as ShowQno, RespText1, RespText2, RespText3, RespText4, RespText5 FROM [Questions] inner join Scale on Questions.LanguageID=Scale.LanguageID WHERE (Questions.[LanguageID] = @LanguageID) and QNo BETWEEN 13 AND 16 ">
        <SelectParameters>
            <asp:CookieParameter CookieName="LanguageID" DefaultValue="1" Name="LanguageID" Type="Byte" />
        </SelectParameters>
    </asp:SqlDataSource>
    <div class="tude latitude">LATITUDE</div>
    <div class="stem">Is your company willing to adapt to the new ways of doing business? The company is prepared to…:</div>
    <table>
        <tr>
            <td>
